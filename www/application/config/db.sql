...
INSERT INTO user (id, name, surname, email, password, authLevel) VALUES
         (1, 'Lucaste', 'Cemolli', 'admin@band.ch', sha2('Password&1', 256), 1),
         (2, 'John', 'Doe', 'john.doe@band.ch', sha2('Password&1', 256), 0),
         (3, 'Jane', 'Smith', 'jane.smith@band.ch', sha2('Password&1', 256), 0);


INSERT INTO band_user (bandId, userId) VALUES
        (1, 1), (2, 1), (3, 1),
        (2, 2), (2, 3);
